...
describe('The update utils', () => {
    ...
    it('Successfully updates Ubuntu 18.04 to Ubuntu 20.04', () => {
        ...
        const updatedProfile = updateProfileUsingXCCDF(ubuntu1804, fs.readFileSync(`test/sample_data/xccdf/input/CIS/ssg-ubuntu2004-xccdf.xml`, 'utf-8'), 'group', createWinstonLogger())
