...
describe('The control functionality', () => {
  ...
  /* To update or change this test, do the following:
   ...
   // NOTE:
   //   The "expected" file was generated using end of line characters (CRLF). We remove all CR from both files before comparing
   //   We use the JSON.stringify to force an inequality if the 
