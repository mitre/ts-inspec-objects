...
describe('The diff utils', () => {
    ...
    it.only('Successfully finds the difference between a RHEL 8 V2R6 InSpec Profile and V2R7 XCCDF', () => {
        ...
        console.log(diffProfile(V2R6, V2R7))
    ...
    it('Successfully finds the difference between a Ubuntu 18.04 InSpec Profile and Ubuntu 20.04 CIS Benchmark', () => {
        ...
        const ubuntu2004 = processXCCDF(fs.readFileSync('test/sample_data/xccdf/input/Canonical_Ubuntu_20.04-xccdf.xml', 'utf-8'), true, 'group')
